...
//  Flag for streaming a long sound to reduce load time
#define SGD_FMOD_STREAMING_LOOPING		SGD_FMOD_LOOPING | FMOD_CREATESTREAM
...
class CSGD_FModManager
{
	...
	struct tSoundInfo
	{
		...
		float fVolume;					//  The current volume of this sound
		float fPan;						//  The current pan of this sound
		float fFreq;
...
public:
	...
	//
	// Function parameters :
	//   [nID] -			The ID of the sound whos volume we want
	//
	// Return - [float]: the volume value of the id we are checking
	//					 between 0.0f and 1.0f
	////////////////////////////////////////////////////////////////////////
	float GetVolume(int nID);
	...
	//
	// Function parameters :
	//   [nID] -			The ID of the sound whos frequency we want
	//
	// Return - [float]: the frequency value of the id we are checking
	//					 between 0.0f and 44100.0f
	////////////////////////////////////////////////////////////////////////
	float GetFrequency(int nID);
	...
	//
	// Function parameters :
	//   [nID] -			The ID of the sound whos pan we want
	//
	// Return - [float]: the pan value of the id we are checking
	//					 between -1.0f and 1.0f
	////////////////////////////////////////////////////////////////////////
	float GetPan(int nID);
